...
Begin VB.Form frmParametro 
   ...
   Begin TrueOleDBGrid80.TDBGrid tdbgrdData 
      ...
      Columns(0).DataField=   "IDParametro"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Texto"
      Columns(1).DataField=   "Texto"
      Columns(1).ConvertEmptyCell=   1
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Número Entero"
      Columns(2).DataField=   "NumeroEntero"
      Columns(2).NumberFormat=   "#,###"
      Columns(2).ConvertEmptyCell=   1
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "Número Decimal"
      Columns(3).DataField=   "NumeroDecimal"
      ...
      Columns(5).Caption=   "Fecha/Hora"
      Columns(5).DataField=   "FechaHora"
      Columns(5).ConvertEmptyCell=   1
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   20
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "Sí/No"
      Columns(6).DataField=   "SiNo"
      ...
      Splits(0)._ColumnProps(6)=   "Column(1).Width=5821"
      ...
      Splits(0)._ColumnProps(26)=   "Column(5).Width=2461"
      Splits(0)._ColumnProps(27)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(28)=   "Column(5)._WidthInPix=2381"
      ...
      _StyleDefs(49)  =   "Splits(0).Columns(3).HeadingStyle:id=59,.parent=14,.alignment=2"
      _StyleDefs(50)  =   "Splits(0).Columns(3).FooterStyle:id=60,.parent=15"
      _StyleDefs(51)  =   "Splits(0).Columns(3).EditorStyle:id=61,.parent=17"
      _StyleDefs(52)  =   "Splits(0).Columns(4).Style:id=58,.parent=13,.alignment=1"
      ...
      _StyleDefs(60)  =   "Splits(0).Columns(6).Style:id=54,.parent=13,.alignment=2"
...
Private Sub Form_Load()
    ...
    recData.Properties("Update Criteria").Value = adCriteriaKey
    Set cmdData = Nothing
...
ErrorHandler:
    ShowErrorMessage "Forms.Parametro.Load", "Error al abrir la tabla de Parametros."
End Sub
...
Private Sub Form_Resize()
    ...
    With tdbgrdData
        .Top = CONTROL_SPACE
        .Left = CONTROL_SPACE
        .Height = Me.ScaleHeight - .Top - CONTROL_SPACE
        .Width = Me.ScaleWidth - .Left - CONTROL_SPACE
    End With
End Sub
