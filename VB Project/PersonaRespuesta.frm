    ...
    Select Case Button.Key
        ...
        Case "ACTIVATE"
            If pCPermiso.GotPermission(PERMISO_PERSONA_RESPUESTA_ACTIVATE_ALL) Then
                If MsgBox("Se Activarán todas las Respuestas de esta Persona." & vbCr & vbCr & "¿Desea continuar?", vbExclamation + vbYesNo, App.Title) = vbYes Then
        ...
        Case "DEACTIVATE"
            If pCPermiso.GotPermission(PERMISO_PERSONA_RESPUESTA_ACTIVATE_ALL) Then
                If MsgBox("Se Desactivarán todas las Respuestas de esta Persona." & vbCr & vbCr & "¿Desea continuar?", vbExclamation + vbYesNo, App.Title) = vbYes Then
